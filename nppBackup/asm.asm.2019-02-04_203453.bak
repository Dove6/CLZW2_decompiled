...
.text:10034CE8
.text:100EAA90 ; ---------------------------------------------------------------------------			WSZELKI WZMIANKI O SŁOWNIKU DOTYCZĄ KODU
...
.text:100EAAB8                 lea     ebp, [esi+eax]		; ebp <- adres końcowy kodu
...
.text:100EAAC4                 and     ecx, 0FFh			; przycięcie słowa do 16 bitów (wcześniej w ch była reszta adresu pierwszego znaku kodu)
